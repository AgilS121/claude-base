...
const PROJECT_SLUG = process.env.PROJECT_SLUG ?? "simlab-v2-fe";
const PROJECT_PATH =
  process.env.PROJECT_PATH ?? "d:\\HSD\\SIMLAB\\old-simlab-v2-fe";
const CLAUDE_HOME =
...
const server = new Server(
  { name: "simlab-v2-fe", version: "0.1.0" },
  { capabilities: { tools: {} } }
);
...
console.error(
  `[simlab-v2-fe-mcp] connected. project=${PROJECT_SLUG} path=${PROJECT_PATH}`
);
